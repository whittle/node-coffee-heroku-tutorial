...
public_dir      = "public/node-coffee-heroku-tutorial"    # compiled site directory
...
desc "Clean out caches: .pygments-cache, .gist-cache, .gist-it-cache, .sass-cache"
task :clean do
  rm_rf [".pygments-cache/**", ".gist-cache/**", ".gist-it-cache/**", ".sass-cache/**", "source/stylesheets/screen.css"]
end
